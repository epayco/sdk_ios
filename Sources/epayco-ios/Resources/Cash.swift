...
public struct Cash: NetworkManagerDelegate {
    public var publicKey: String
    public var privateKey: String
    public var test: Bool

    public init(_ publicKey: String, _ privateKey: String, _ test: Bool){
    ...
    public func create(paymentMethod: String, newCashTransactionData: NewCashTransactionModel) -> CashTransactionModel? {
        ...
        let cashCreateData = NewCashTransactionCallModel(
            ...
            descripcion: newCashTransactionData.description,
            valor: newCashTransactionData.value,
            iva: newCashTransactionData.tax,
            baseiva: newCashTransactionData.taxBase,
            moneda: newCashTransactionData.currency,
            tipo_persona: newCashTransactionData.personType,
            tipo_doc: newCashTransactionData.docType,
            documento: newCashTransactionData.docNumber,
            nombres: newCashTransactionData.name,
            apellidos: newCashTransactionData.lastName,
            email: newCashTransactionData.email,
            celular: newCashTransactionData.cellPhone,
            fechaexpiracion: newCashTransactionData.endDate,
            url_respuesta: newCashTransactionData.responseUrl,
            url_confirmacion: newCashTransactionData.confirmationUrl,
