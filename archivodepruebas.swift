...
    let publicKey = "b08da971657629f146a8b15aea3b02e2"

    let privateKey = "a40dea800a1c9a048bfb9bd28cb69335"
...
        let tokenCreated = tokenClass.create(newTokenData: newTokenModel)
        ...
        case .success(let tokenModel):
            ...
            guard let token_id = tokenModel.data.id else {
...
        let cashTransaction = epayco.cash.create(paymentMethod: "efecty", newCashTransactionData: newCashTransactionModel)
        ...
        case .success(let transaction):
            ...
            print("Ref: \(transaction.data?.ref_payco ?? "N/A")")
        case .failure(let error):
